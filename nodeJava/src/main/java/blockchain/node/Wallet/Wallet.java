...
public class Wallet {
    ...
    public float getBalance() {
        ...
        for(Map.Entry<String, TransactionOutput> item: NodeApplication.UTXOs.entrySet()) {
    ...
    public Transaction sendFunds(PublicKey _recipient, float value) {
        ...
        Transaction newTransaction = new Transaction(publicKey, _recipient, value, transactionInputs);
